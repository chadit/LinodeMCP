...
FEATURE_TOOLS_LIST = (
    ...
    "linode_nodebalancer_config_node_get,linode_nodebalancer_config_rebuild,linode_nodebalancer_config_node_update,linode_nodebalancer_create,linode_nodebalancer_update,"
