...
FEATURE_TOOLS_LIST = (
    ...
    "linode_instances_list,linode_instance_configs_list,linode_instance_config_get,linode_instance_config_interfaces_list,linode_instance_config_update,linode_instance_config_delete,"
