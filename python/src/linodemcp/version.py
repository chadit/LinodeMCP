...
FEATURE_TOOLS_LIST = (
    "hello,version,linode_profile,linode_profile_preferences_get,linode_profile_preferences_update,linode_profile_phone_number_delete,linode_profile_phone_number_send,linode_profile_phone_number_verify,linode_profile_device_revoke,linode_profile_tfa_disable,linode_profile_tfa_enable,linode_profile_tfa_enable_confirm,linode_account,linode_account_update,linode_account_cancel,linode_account_agreements_acknowledge,linode_account_beta_get,linode_account_child_account_get,linode_account_invoice_get,linode_account_oauth_client_create,linode_account_oauth_client_delete,linode_account_oauth_client_get,linode_account_payment_create,linode_account_payment_get,linode_account_promo_credit_add,linode_account_payment_method_create,linode_account_payment_method_delete,linode_account_payment_method_get,linode_account_service_transfer_create,linode_account_service_transfer_delete,linode_account_service_transfer_get,linode_account_service_transfers_list,linode_account_settings_get,linode_account_oauth_client_thumbnail_get,linode_account_oauth_client_thumbnail_update,linode_account_oauth_client_update,linode_account_beta_enroll,"
