...
FEATURE_TOOLS_LIST = (
    ...
    "linode_types_list,linode_volumes_list,linode_volume_get,linode_volume_types_list,linode_image_create,linode_image_sharegroup_create,linode_images_list,linode_images_sharegroup_delete,linode_images_sharegroup_get,linode_images_sharegroup_image_delete,linode_images_sharegroup_image_update,linode_images_sharegroup_images_add,linode_images_sharegroup_images_list,linode_images_sharegroup_members_list,linode_images_sharegroup_update,linode_images_sharegroups_list,linode_images_sharegroups_token_create,linode_images_sharegroups_token_delete,linode_images_sharegroups_token_get,linode_images_sharegroups_token_sharegroup_get,linode_images_sharegroups_token_sharegroup_images_list,linode_images_sharegroups_token_update,linode_images_sharegroups_tokens_list,"
