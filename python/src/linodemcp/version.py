...
FEATURE_TOOLS_LIST = (
    "hello,version,linode_profile,linode_profile_preferences_get,linode_profile_preferences_update,linode_profile_phone_number_verify,linode_profile_tfa_disable,linode_profile_tfa_enable,linode_profile_tfa_enable_confirm,linode_account,linode_account_update,"
