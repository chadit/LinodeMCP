...
FEATURE_TOOLS_LIST = (
    ...
    "linode_stackscripts_list,linode_stackscript_get,linode_stackscript_create,linode_stackscript_update,linode_stackscript_delete,linode_sshkey_create,linode_sshkey_update,linode_sshkey_delete,"
    "linode_instance_boot,linode_instance_reboot,linode_instance_shutdown,linode_instance_firewalls_apply,linode_instance_interface_settings_update,"
    ...
    "linode_lke_dashboard_get,linode_lke_api_endpoints_list,linode_longview_client_delete,linode_longview_client_get,linode_longview_client_update,linode_longview_clients_list,linode_longview_plan_get,linode_longview_plan_update,linode_longview_types_list,linode_monitor_dashboard_get,linode_monitor_alert_channels_list,linode_monitor_alert_definitions_list,linode_monitor_dashboards_list,"
