...
FEATURE_TOOLS_LIST = (
    ...
    "linode_instance_get,linode_regions_list,linode_kernels_list,"
    ...
    "linode_lke_dashboard_get,linode_lke_api_endpoints_list,linode_longview_client_delete,linode_longview_client_update,linode_longview_clients_list,linode_monitor_dashboard_get,linode_monitor_alert_channels_list,linode_monitor_alert_definitions_list,linode_monitor_dashboards_list,"
