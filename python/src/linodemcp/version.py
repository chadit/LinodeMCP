...
FEATURE_TOOLS_LIST = (
    ...
    "linode_instances_list,linode_instance_nodebalancers_list,linode_instance_stats_month_get,linode_instance_interfaces_list,linode_instance_interface_add,linode_instance_interface_update,linode_instance_interface_delete,linode_instance_interface_settings_get,linode_instance_configs_list,linode_instance_config_get,linode_instance_config_interface_add,linode_instance_config_interface_delete,linode_instance_config_interface_get,linode_instance_config_interface_update,linode_instance_interfaces_history_list,linode_instance_config_interfaces_list,linode_instance_config_interfaces_order,linode_instance_config_update,linode_instance_config_delete,"
