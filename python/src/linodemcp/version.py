...
FEATURE_TOOLS_LIST = (
    ...
    "linode_types_list,linode_volumes_list,linode_volume_get,linode_volume_types_list,linode_image_create,linode_images_list,linode_images_sharegroups_list,linode_images_sharegroups_token_create,linode_images_sharegroups_token_delete,linode_images_sharegroups_token_get,linode_images_sharegroups_token_update,linode_images_sharegroups_tokens_list,"
