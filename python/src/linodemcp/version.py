...
FEATURE_TOOLS_LIST = (
    ...
    "linode_stackscripts_list,linode_stackscript_get,linode_stackscript_create,linode_stackscript_update,linode_sshkey_create,linode_sshkey_update,linode_sshkey_delete,"
