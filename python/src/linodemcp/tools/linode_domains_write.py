...
_DOMAIN_CREATE_OPTIONAL_STRING_FIELDS = ("description", "group")
_DOMAIN_CREATE_STRING_FIELDS = ("soa_email", "status")
...
def _domain_create_integer_fields_error(arguments: dict[str, Any]) -> str | None:
    """Return an integer-field validation error, if any."""
...
def _domain_create_optional_fields_error(arguments: dict[str, Any]) -> str | None:
    ...
    for name in _DOMAIN_CREATE_OPTIONAL_STRING_FIELDS:
...
def _domain_create_request(
    ...
    """Validate domain-create arguments and preserve optional-field presence."""
    ...
    for name in (
        ...
        *_DOMAIN_CREATE_INTEGER_FIELDS,
        *_DOMAIN_CREATE_OPTIONAL_STRING_FIELDS,
