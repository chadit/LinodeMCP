...
class Client:
    ...
    async def get_instance_transfer(self, linode_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            raise NetworkError("GetInstanceTransfer", e) from e
    ...
    async def delete_instance_config_interface(
        self, linode_id: int, config_id: int, interface_id: int
    ) -> None:
        """Delete an interface from a Linode instance configuration profile."""
        linode_id = _validate_positive_path_int(linode_id, "linode_id")
        config_id = _validate_positive_path_int(config_id, "config_id")
        interface_id = _validate_positive_path_int(interface_id, "interface_id")
        encoded_linode_id = quote(str(linode_id), safe="")
    ...
    async def list_instance_interface_history(
        ...
        try:
            ...
            raise NetworkError("ListInstanceInterfaceHistory", e) from e
    ...
    async def get_image_sharegroup_member_token(
    ...
    async def add_members_to_image_sharegroup(
        ...
        """Add members to an image share group."""
        if not label.strip():
    ...
    async def assign_ips(
        ...
        try:
            ...
            raise NetworkError("AssignIPs", e) from e
    ...
    async def list_instance_interface_firewalls(
        self,
        linode_id: int,
        interface_id: int,
    ) -> dict[str, Any]:
        ...
        try:
            ...
            raise NetworkError("ListInstanceInterfaceFirewalls", e) from e
...
class RetryableClient:
    ...
    async def get_instance_transfer(self, linode_id: int) -> dict[str, Any]:
        """Get this month's network transfer stats for a Linode instance with retry."""
        result: dict[str, Any] = await self._execute_with_retry(
            self.client.get_instance_transfer, linode_id
        )
        return result
    ...
    async def delete_instance_config_interface(
        ...
        """Delete a Linode instance config interface without replay retry."""
        await self.client.delete_instance_config_interface(
    ...
    async def get_image_sharegroup_member_token(
        ...
        """Get a membership token in an image share group with retry."""
        result: dict[str, Any] = await self._execute_with_retry(
            lambda: self.client.get_image_sharegroup_member_token(
    ...
    async def assign_ips(
        ...
        """Assign IPs without replay retry."""
        return await self.client.assign_ips(region, assignments)
    ...
    async def list_lke_tier_versions(self, tier: str) -> list[dict[str, Any]]:
        ...
        result: list[dict[str, Any]] = await self._execute_with_retry(
            self.client.list_lke_tier_versions, tier
        )
        return result
    ...
    async def list_instance_interface_firewalls(
        ...
        """List Linode instance interface firewalls with retry."""
        result: dict[str, Any] = await self._execute_with_retry(
            self.client.list_instance_interface_firewalls,
            linode_id,
            interface_id,
        )
        return result
