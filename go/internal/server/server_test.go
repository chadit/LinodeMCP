...
func TestToolDescriptorsIncludesExpectedTools(t *testing.T) {
	...
	want := map[string]profiles.Capability{
		...
		"linode_image_sharegroup_token_create":               profiles.CapWrite,
		...
		"linode_profile_token_delete":                        profiles.CapAdmin,
		...
		"linode_managed_contact_delete":                      profiles.CapAdmin,
		...
		"linode_managed_service_delete":                      profiles.CapAdmin,
		...
		"linode_longview_client_create":                  profiles.CapWrite,
		"linode_longview_plan_update":                    profiles.CapWrite,
		"linode_beta_list":                               profiles.CapRead,
		"linode_beta_get":                                profiles.CapRead,
		"linode_account_beta_list":                       profiles.CapRead,
		"linode_profile_phone_number_send":               profiles.CapAdmin,
		"linode_profile_phone_number_delete":             profiles.CapAdmin,
		"linode_profile_phone_number_verify":             profiles.CapAdmin,
		...
		"linode_profile_app_delete":                      profiles.CapAdmin,
		"linode_profile_device_get":                      profiles.CapRead,
		"linode_profile_device_revoke":                   profiles.CapAdmin,
...
func TestToolDescriptorsIncludesExpectedToolsExtra(t *testing.T) {
	...
	want := map[string]profiles.Capability{
		...
		"linode_longview_client_update":                         profiles.CapWrite,
		...
		"linode_support_ticket_create":                          profiles.CapWrite,
		"linode_support_ticket_attachment_create":               profiles.CapWrite,
		"linode_support_ticket_reply_create":                    profiles.CapWrite,
		...
		"linode_account_service_transfer_delete":                profiles.CapAdmin,
		"linode_account_service_transfer_accept":                profiles.CapAdmin,
		"linode_account_event_get":                              profiles.CapRead,
		"linode_account_event_seen":                             profiles.CapWrite,
		...
		"linode_database_mysql_instance_credentials_get":        profiles.CapWrite,
		"linode_database_postgresql_instance_credentials_get":   profiles.CapWrite,
		"linode_database_mysql_instance_credentials_reset":      profiles.CapWrite,
		"linode_database_postgresql_instance_credentials_reset": profiles.CapWrite,
