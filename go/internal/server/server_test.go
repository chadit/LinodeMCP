...
func TestToolDescriptorsIncludesExpectedTools(t *testing.T) {
	...
	want := map[string]profiles.Capability{
		...
		"linode_tagged_objects":                                 profiles.CapRead,
		"linode_support_ticket_get":                             profiles.CapRead,
		"linode_support_ticket_replies":                         profiles.CapRead,
		...
		"linode_account_support_ticket_create":                  profiles.CapAdmin,
		"linode_account_support_ticket_attachment_create":       profiles.CapAdmin,
		"linode_account_support_ticket_reply_create":            profiles.CapAdmin,
