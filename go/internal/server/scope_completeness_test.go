...
func scopelessTools() map[string]bool {
	return map[string]bool{
		...
		"linode_iam_role_permission_list":                          true,
		"linode_iam_user_role_permission_get":                      true,
		"linode_iam_user_role_permission_update":                   true,
		"linode_iam_idp_config_list":                               true,
		"linode_iam_idp_config_get":                                true,
		"linode_iam_idp_config_create":                             true,
		"linode_iam_idp_config_update":                             true,
		"linode_iam_idp_config_delete":                             true,
		"linode_iam_idp_config_certificate_list":                   true,
		"linode_iam_idp_config_certificate_create":                 true,
		"linode_iam_idp_config_certificate_delete":                 true,
		"linode_iam_idp_config_excluded_user_list":                 true,
		"linode_iam_idp_config_excluded_user_update":               true,
		"linode_iam_idp_config_included_user_list":                 true,
		"linode_iam_idp_config_included_user_update":               true,
		"linode_iam_delegation_child_account_list":                 true,
		"linode_iam_delegation_child_account_user_list":            true,
		"linode_iam_delegation_child_account_user_update":          true,
		"linode_iam_delegation_default_role_permission_get":        true,
		"linode_iam_delegation_default_role_permission_update":     true,
		"linode_iam_delegation_profile_child_account_list":         true,
		"linode_iam_delegation_profile_child_account_get":          true,
		"linode_iam_delegation_profile_child_account_token_create": true,
		"linode_iam_delegation_user_child_account_list":            true,
		"linode_entity_list":                                       true,
	}
}
