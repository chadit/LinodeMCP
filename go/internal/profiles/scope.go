...
func scopeCategory(toolName string) string {
	switch toolName {
	case "linode_profile", "linode_profile_preferences", "linode_profile_preferences_update", "linode_profile_security_questions", "linode_profile_security_questions_answer", "linode_profile_phone_number_send", "linode_profile_phone_number_delete", "linode_profile_phone_number_verify", "linode_profile_devices", "linode_account":
