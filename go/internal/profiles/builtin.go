...
func Categories(toolName string) []string {
	...
	switch toolName {
	case "hello", "version", "linode_profile", "linode_profile_app_get", "linode_account", "linode_betas", "linode_beta_get", "linode_account_betas", "linode_account_oauth_clients", "linode_account_payment_methods", "linode_account_payment_method_get", "linode_account_payment_method_create", "linode_account_payment_method_delete", "linode_account_payment_method_make_default", "linode_account_notifications", "linode_maintenance_policies", "linode_account_events", "linode_account_users", "linode_account_user_get", "linode_account_user_grants", "linode_account_user_grants_update", "linode_account_user_update", "linode_account_user_delete", "linode_account_user_create", "linode_managed_contact_create", "linode_managed_service_create", "linode_account_invoices", "linode_account_payments", "linode_account_payment_create", "linode_account_promo_credit", "linode_account_invoice_items", "linode_account_beta_get":
