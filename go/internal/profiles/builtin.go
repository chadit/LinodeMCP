...
func Categories(toolName string) []string {
	...
	switch toolName {
	case "hello", "version", "linode_profile", "linode_profile_preferences", "linode_profile_preferences_update", "linode_profile_token_create", "linode_profile_token_delete", "linode_profile_security_questions", "linode_profile_security_questions_answer", "linode_profile_tokens", "linode_profile_token_update", "linode_profile_devices", "linode_profile_login_get", "linode_profile_tfa_enable", "linode_profile_tfa_enable_confirm", "linode_profile_phone_number_send", "linode_profile_phone_number_delete", "linode_profile_phone_number_verify", "linode_profile_tfa_disable", "linode_profile_app_get", "linode_profile_app_delete", "linode_profile_device_get", "linode_profile_device_revoke", "linode_profile_apps", "linode_account", "linode_betas", "linode_beta_get", "linode_account_betas", "linode_account_oauth_clients", "linode_account_payment_methods", "linode_account_payment_method_get", "linode_account_payment_method_create", "linode_account_payment_method_delete", "linode_account_payment_method_make_default", "linode_account_notifications", "linode_tags", "linode_tag_create", "linode_tag_delete", "linode_maintenance_policies", "linode_account_events", "linode_tagged_objects", "linode_support_ticket_replies", "linode_support_tickets", "linode_support_ticket_close", "linode_account_users", "linode_account_user_get", "linode_profile_token_get", "linode_account_user_grants", "linode_account_user_grants_update", "linode_account_user_update", "linode_account_user_delete", "linode_account_user_create", "linode_account_support_ticket_create", "linode_account_support_ticket_attachment_create", "linode_account_support_ticket_reply_create", "linode_managed_contact_create", "linode_managed_service_create", "linode_account_invoices", "linode_account_payments", "linode_account_payment_create", "linode_account_promo_credit", "linode_account_invoice_items", "linode_account_beta_get":
