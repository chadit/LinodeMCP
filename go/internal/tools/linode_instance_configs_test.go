...
func instanceConfigCreateValidationCases() []instanceConfigCreateValidationCase {
	return []instanceConfigCreateValidationCase{
		...
		{name: "null interfaces", args: map[string]any{keyLinodeID: float64(123), keyLabel: labelBootConfig, keyDevices: configDevicesSDAJSON, keyInterfaces: databaseJSONNull, keyConfirm: true}, wantContains: "interfaces must be an array of objects"},
...
func TestLinodeInstanceConfigUpdateToolValidation(t *testing.T) {
	...
	validationTests := []instanceConfigCreateValidationCase{
		...
		{name: "null interfaces", args: map[string]any{keyLinodeID: float64(123), keyConfigID: float64(789), keyInterfaces: databaseJSONNull, keyConfirm: true}, wantContains: "interfaces must be an array of objects"},
