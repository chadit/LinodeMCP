...
func TestLinodeSSHKeyCreateToolDryRun(t *testing.T) {
	t.Parallel()
	...
	t.Run("preview without creating", func(t *testing.T) {
		...
		assert.Equal(t, "linode_sshkey_create", body["tool"])
...
func TestLinodeSSHKeyUpdateToolDryRun(t *testing.T) {
	...
	t.Run("preview without updating", func(t *testing.T) {
		...
		var body map[string]any
		require.NoError(t, json.Unmarshal([]byte(dryRunResultText(t, result)), &body))
		assert.Equal(t, "linode_sshkey_update", body["tool"])
	...
	t.Run("still validates sshkey_id", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.True(t, result.IsError)
		assertErrorContains(t, result, "sshkey_id must be a positive integer")
	})
}
...
func TestLinodeSSHKeyDeleteToolDryRun(t *testing.T) {
	...
	t.Run("preview without deleting", func(t *testing.T) {
		...
		var body map[string]any
		require.NoError(t, json.Unmarshal([]byte(dryRunResultText(t, result)), &body))
		assert.Equal(t, "linode_sshkey_delete", body["tool"])
