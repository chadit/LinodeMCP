...
const (
	...
	// Common JSON request/response keys. The three support-ticket keys were
	// rehomed here when that tool became generated; the names they carry
	// are the plain argument names their many callers spell.
	...
	// errRulesNotObject is the sentence a firewall ruleset that is not an
	// object is refused with, wherever the ruleset is read.
	errRulesNotObject            = "rules must be an object"
	keyKernel                    = "kernel"
	...
	// keyRouteIPv6 is the flat route flag an instance create folds into the
	// interface it synthesizes.
	keyRouteIPv6                  = "route_ipv6"
	...
	errStackScriptIDRequired              = "stackscript_id is required"
	...
	// scopeLinodesReadWrite is the token scope the draft fixtures carry.
	...
	errBackupIDPositive         = "backup_id must be a positive integer"
	errDiskIDPositive           = "disk_id must be a positive integer"
	...
	errRecordIDPositive         = "record_id must be a positive integer"
	...
	caseNegativeDomainID          = "negative domain id"
