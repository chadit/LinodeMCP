...
const (
	...
	caseNonIntegerPage            = "non-integer page"
	casePageBelowOne              = "page below one"
	casePageSizeBelowMin          = "page_size below the minimum"
	casePageSizeAboveMax          = "page_size above the maximum"
	errPageBelowOne               = "page must be an integer greater than or equal to 1"
	slugPublic                    = "public"
