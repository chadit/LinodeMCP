...
const (
	...
	errNodeIDInteger                      = "node_id must be an integer"
	...
	errLongviewClientIDNoSeparators       = "client_id must not contain path separators"
	...
	errPaymentMethodIDInteger      = "payment_method_id must be an integer"
