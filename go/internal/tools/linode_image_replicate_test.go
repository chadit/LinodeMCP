...
func TestLinodeImageReplicateToolValidationClientErrorTt(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{name: "non-string region element", args: map[string]any{keyImageID: privateImage123Fixture, keyRegions: []any{float64(123)}, keyConfirm: true}, want: "regions must be an array of strings"},
		{name: "malformed regions", args: map[string]any{keyImageID: privateImage123Fixture, keyRegions: `[`, keyConfirm: true}, want: "regions must be an array of strings"},
