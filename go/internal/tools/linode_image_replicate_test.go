...
func TestLinodeImageReplicateToolValidation(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{name: caseTraversalImageID, args: map[string]any{keyImageID: "private/..", keyRegions: singleRegionJSON, keyConfirm: true}, want: errImageIDPathFragment},
		...
		{name: "zero private image id", args: map[string]any{keyImageID: "private/0", keyRegions: singleRegionJSON, keyConfirm: true}, want: errImageIDPathFragment},
