...
func TestLinodeSupportTicketsTool(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		tickets := linode.PaginatedResponse[linode.SupportTicket]{
			Data:    []linode.SupportTicket{{ID: 11111, Summary: "Cannot reach managed instance", Status: "ticket-open", OpenedBy: "adevi"}},
			Page:    2,
			Pages:   3,
			Results: 75,
		}
		...
		assert.Contains(t, textContent.Text, "Cannot reach managed instance", "response should contain ticket summary")
		assert.Contains(t, textContent.Text, "adevi", "response should contain opener")
	})
